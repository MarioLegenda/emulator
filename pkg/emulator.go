...
func NewEmulator(options Options) Emulator {
	if options.LogDirectory == "" {
		log.Fatalln("No LOG_DIRECTORY specified. Log directory must be specified...")
	}

	if options.ExecutionDirectory == "" {
		log.Fatalln("No EXECUTION_DIR directory specified. Execution directory must be specified...")
	}

	logger.BuildLoggers(options.LogDirectory)
